...
public class b_variable_length_arguments {
    public int sumNum(int... args) {
        int sum = 0;
        System.out.println("The number of argument(s) = " + args.length);
        for (int i : args) {
            sum += i; // sum = sum + i;
        }
        return sum;
