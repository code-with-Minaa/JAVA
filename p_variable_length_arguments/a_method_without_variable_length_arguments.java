...
public class a_method_without_variable_length_arguments {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The sum of two same integers = " + obj.add(1));
        System.out.println("The sum of two integers = " + obj.add(1, 2));
        System.out.println("The sum of three integers = " + obj.add(1, 2, 3));
    }
}